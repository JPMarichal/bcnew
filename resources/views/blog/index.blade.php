                    ...
                    <div class="card h-100">
                        <div class="m-2 p-2 border rounded" style="height:100px;">
                            ...
                            <a href="{{ route('blog.show', $post->slug) }}">
                                <img src="{{ $post->featuredImageUrl() }}" class="card-img-top" style="height: 100px; object-fit: cover;" alt="{{ $post->title }}">
                            </a>
                        </div>
                        <div class="card-body">
                            <h5 class="card-title">
                                <a class="text-success" href="{{ route('blog.show', $post->slug) }}">{{$post->id}} {{ $post->title }}</a>
                            </h5>
