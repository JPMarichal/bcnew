<aside class="barra-flotante" style="border: 1px solid grey; padding: 10px; text-align: center;">
    ...
    'pinterest' => ['icon' => 'fa-pinterest-p', 'color' => '#BD081C', 'name' => 'Pinterest', 'shareUrl' => "http://pinterest.com/pin/create/button/?url={$url}&description={$description}&media={$featuredImage}"],
