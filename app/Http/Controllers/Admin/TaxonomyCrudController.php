...
class TaxonomyCrudController extends CrudController
{
    ...
    protected function setupCreateOperation()
    {
        ...
        // Omitir CRUD::setFromDb(); para personalizar los campos

        CRUD::field('name')->type('text')->attributes([
            'placeholder' => 'Ingrese el nombre'
        ])->wrapper([
            'class' => 'form-group col-md-6'
        ]);

        // El campo type como un select
        CRUD::field([
            'name' => 'type',
            'label' => "Type",
        ...
        // Los campos slug y created_by se gestionarán automáticamente en el modelo
    }
