...
use App\Http\Requests\Escrituras\DivisionRequest;
...
class DivisionCrudController extends CrudController
{
    ...
    {
        CRUD::setModel(\App\Models\Escrituras\Division::class);
        CRUD::setRoute(config('backpack.base.route_prefix') . '/escrituras/division');
